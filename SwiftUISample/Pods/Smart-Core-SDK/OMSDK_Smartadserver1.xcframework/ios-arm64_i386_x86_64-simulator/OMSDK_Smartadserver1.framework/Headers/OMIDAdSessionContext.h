 ...
 */
@interface OMIDSmartadserver1AdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDSmartadserver1Partner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDSmartadserver1Partner *)partner
                               ...
                               resources:(NSArray<OMIDSmartadserver1VerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
