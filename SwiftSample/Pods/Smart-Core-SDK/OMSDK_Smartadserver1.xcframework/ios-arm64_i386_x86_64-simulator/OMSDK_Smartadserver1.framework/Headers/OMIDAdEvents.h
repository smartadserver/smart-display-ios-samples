 ...
 */
@interface OMIDSmartadserver1AdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDSmartadserver1AdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDSmartadserver1VASTProperties *_Nonnull)vastProperties
